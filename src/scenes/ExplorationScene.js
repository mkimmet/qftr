  ...
  constructor(gameEngine) {
    ...
    this.rooms = {
      town_square: {
        ...
        depthScale: { yMin: 320, yMax: 650, minScale: 3.0, maxScale: 5.6 },
        exits: {
      ...
      magic_shop: {
        ...
        depthScale: { yMin: 340, yMax: 640, minScale: 4.4, maxScale: 5.4 },
        exits: {
      ...
      guild_hall: {
        ...
        depthScale: { yMin: 340, yMax: 620, minScale: 4.4, maxScale: 5.4 },
        exits: {
      ...
      forest_path: {
        ...
        bounds: { xMin: 50, xMax: 1230, yMin: 320, yMax: 650 },
        depthScale: { yMin: 300, yMax: 650, minScale: 2.8, maxScale: 5.8 },
        exits: {
